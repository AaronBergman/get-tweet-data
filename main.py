...
''')
    ...
    # Embed the PayPal donation form
    paypal_form = """
<form action="https://www.paypal.com/donate" method="post" target="_top">
<input type="hidden" name="business" value="PJBNFHJBWLEVS" />
<input type="hidden" name="no_recurring" value="0" />
<input type="hidden" name="item_name" value="Don't give me any money that you'd otherwise donate to an effective charity" />
